                ...
                >
                    <Card className="h-full squircle-xl glass-card-premium p-6 hover-lift group relative overflow-hidden flex flex-col">
                        ...
                        <div className="flex justify-between items-start mb-6 relative z-10 transition-colors duration-300">
                            <Badge className={`geo-sharp border-0 px-2.5 py-1 ${org.is_active ? 'bg-success/20 text-success' : 'bg-destructive/20 text-destructive'}`}>
                        ...
                        <div className="space-y-3 mb-8 relative z-10">
                            <div className="flex items-center justify-between p-3 rounded-2xl bg-muted/20 border border-white/5">
                                ...
                                <Badge variant="outline" className="geo-sharp border-primary/30 text-primary font-black text-xs px-3">
                        ...
                        <div className="flex items-center justify-between mt-auto pt-4 border-t border-muted/20 relative z-10">
                            <div className="flex items-center gap-2">
                                <div className={`w-2 h-2 rounded-full ${org.stripe_account_id ? 'bg-success animate-pulse' : 'bg-muted-foreground/30'}`} />
                            ...
                            <div className="flex gap-2">
                                <Button
                                    ...
                                    size="icon"
                                    onClick={() => onEdit(org)}
                                    className="geo-round h-9 w-9 p-0 hover:bg-primary/10 hover:text-primary"
                                >
                                ...
                                <Button
                                    ...
                                    className="geo-round h-9 w-9 p-0 hover:bg-destructive/10 hover:text-destructive"
                                >
