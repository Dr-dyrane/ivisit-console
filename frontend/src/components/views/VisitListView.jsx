            ...
            <div className={`rounded-card p-4 transition-colors group ${selected ? 'bg-muted/50' : 'bg-background/30 hover:bg-muted/30'}`}>
              <div className="flex items-center gap-4 justify-between">
                ...
                <div className="flex-1 min-w-0 grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  {/* Doctor */}
                  <div className="hidden md:block">
                    <span className="text-[10px] font-semibold text-muted-foreground tracking-[0.14em] block mb-1">Doctor</span>
                    <div className="flex items-center gap-2 font-semibold text-sm truncate">
                  ...
                  {/* Hospital */}
                  <div className="hidden md:block">
                    <span className="text-[10px] font-semibold text-muted-foreground tracking-[0.14em] block mb-1">Facility</span>
                    <div className="flex items-center gap-2 font-semibold text-sm truncate">
                ...
                <div className="flex items-center gap-2">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="rounded-inner bg-background/80 shadow-sm">
