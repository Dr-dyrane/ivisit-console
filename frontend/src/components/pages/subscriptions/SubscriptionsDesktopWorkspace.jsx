  ...
  return (
    ...
    >
      ...
      <div className="flex min-w-0 items-center gap-3">
        <span className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-icon ${statusTone(subscriber.status)}`}>
      ...
      <StatusPill label={subscriber.status || 'pending'} className={statusTone(subscriber.status)} compact />
