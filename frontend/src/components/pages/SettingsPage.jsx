  ...
  return (
    <div className="min-h-screen bg-background p-6 md:p-8">
      <motion.div 
        ...
        className="mb-8"
      >
        <h1 className="editorial-title text-4xl mb-2">Settings & Profile</h1>
        <p className="text-muted-foreground font-semibold text-lg">Manage your identity, preferences, and access control</p>
      </motion.div>
