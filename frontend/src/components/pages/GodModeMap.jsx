  ...
  return (
    <div className="min-h-screen bg-background p-6 md:p-8">
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            <button onClick={() => navigate('/')} className="w-12 h-12 bento glass hover-lift flex items-center justify-center">
              <ArrowLeft className="h-5 w-5" />
            </button>
            <div>
              <h1 className="text-3xl md:text-4xl font-bold">God Mode Map</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        >
          <Card className="h-[calc(100vh-16rem)] bento-lg p-0 overflow-hidden glass shadow-bento">
        ...
        <div className="space-y-4">
          ...
          >
            <Card className="bento-lg glass shadow-bento p-6">
              <h3 className="font-semibold mb-4 flex items-center gap-2">
                <Filter className="h-4 w-4" />
                Live Statistics
              </h3>
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bento bg-primary/10">
                  <span className="text-sm font-medium">Active Emergencies</span>
                  <Badge className="bento bg-primary text-primary-foreground">
                    {emergencyRequests.length}
                  </Badge>
                </div>
                <div className="flex items-center justify-between p-3 bento bg-success/10">
                  <span className="text-sm font-medium">Available Units</span>
                  <Badge className="bento bg-success text-success-foreground">
                    {ambulances.length}
                  </Badge>
                </div>
              </div>
                ...
                <Card className="bento-lg glass shadow-bento p-6">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <button
                      ...
                      className="w-8 h-8 bento hover:bg-muted flex items-center justify-center"
                    >
                      ×
                    </button>
                  </div>
                  ...
                  {selectedMarker.type === 'request' ? (
                    <div className="space-y-3">
                      <div className="p-3 bento bg-muted/50">
                      ...
                      <div className="p-3 bento bg-muted/50">
                        ...
                        <Badge className={`bento ${getStatusBadgeColor(selectedMarker.data.status)}`}>
                    ...
                    <div className="space-y-3">
                      <div className="p-3 bento bg-muted/50">
                        <p className="text-xs text-muted-foreground mb-1">Call Sign</p>
                      ...
                      <div className="p-3 bento bg-muted/50">
                        <p className="text-xs text-muted-foreground mb-1">Status</p>
                        <Badge className="bento bg-success/20 text-success">
                          Available
                        </Badge>
                      </div>
                    </div>
