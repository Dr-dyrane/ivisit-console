    ...
    return (
        <div className="space-y-4">
            ...
            >
                ...
                <div className="bg-success/5 p-4 rounded-card flex items-center justify-between group transition-all">
                    ...
                    <Badge className="bg-success/20 text-success rounded-pill">{activeOrgs}</Badge>
                </div>

                <div className="grid grid-cols-2 gap-2">
                    <div className="bg-primary/5 p-4 rounded-inner group">
                    ...
                    <div className="bg-info/5 p-4 rounded-inner group">
                        <div className="flex items-center gap-2 mb-1">
            ...
            <div className="grid grid-cols-3 gap-2">
                <button
                    ...
                    className="flex flex-col items-center justify-center gap-2 p-3 rounded-button bg-primary/10 hover:bg-primary/20 transition-all group"
                >
                ...
                <button
                    ...
                    className="flex flex-col items-center justify-center gap-2 p-3 rounded-button bg-info/10 group opacity-60 cursor-not-allowed"
                >
                ...
                <button
                    ...
                    className="flex flex-col items-center justify-center gap-2 p-3 rounded-button bg-secondary/30 dark:bg-white/5 group opacity-60 cursor-not-allowed"
                >
            ...
            <div className="p-4 rounded-inner bg-white/5 flex items-center gap-3">
                <div className="w-8 h-8 rounded-icon bg-primary/10 flex items-center justify-center flex-shrink-0">
