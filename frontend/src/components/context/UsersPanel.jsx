      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between p-3 rounded-lg bg-warning/10 border border-warning/20">
            ...
            <Badge className="bg-warning/20 text-warning border-0 text-sm font-bold">
              {adminCount}
            </Badge>
          </div>
          ...
          <div className="flex items-center justify-between p-3 rounded-lg bg-success/10 border border-success/20">
            ...
            <Badge className="bg-success/20 text-success border-0 text-sm font-bold">
              {providerCount}
            </Badge>
          </div>
          ...
          <div className="flex items-center justify-between p-3 rounded-lg bg-info/10 border border-info/20">
            ...
            <Badge className="bg-info/20 text-info border-0 text-sm font-bold">
              {patientCount}
            </Badge>
          </div>
        </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <Button
            ...
            className="w-full justify-start h-10 bg-muted/20 hover:bg-muted/30 border border-border/20 text-[10px] font-black tracking-widest uppercase text-foreground"
          >
          ...
          <Button
            ...
            className="w-full justify-start h-10 bg-primary/10 hover:bg-primary/20 border border-primary/20 text-[10px] font-black tracking-widest uppercase text-primary"
          >
