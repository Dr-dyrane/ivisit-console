    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="p-4 bg-primary/5 rounded-card flex flex-col gap-1 group">
          ...
          <div className="p-4 bg-success/5 rounded-card flex flex-col gap-1 group">
            <div className="flex items-center gap-2">
      ...
      <div className="space-y-1.5">
        ...
        <div className="flex flex-col gap-1">
          <div className="flex items-center justify-between p-3 rounded-inner bg-warning/5 transition-colors hover:bg-warning/10">
            <div className="flex items-center gap-2">
              <Shield className="h-4 w-4 text-warning" />
              <span className="text-xs font-medium">Admins</span>
            </div>
            <Badge className="bg-warning/20 text-warning rounded-pill text-[10px] font-bold">
              {(statistics ? ((statistics.roleDistribution?.admin || 0) + (statistics.roleDistribution?.org_admin || 0)) : adminCount)}
            </Badge>
          </div>

          <div className="flex items-center justify-between p-3 rounded-inner bg-success/5 transition-colors hover:bg-success/10">
            <div className="flex items-center gap-2">
              <Stethoscope className="h-4 w-4 text-success" />
              <span className="text-xs font-medium">Providers</span>
            </div>
            <Badge className="bg-success/20 text-success rounded-pill text-[10px] font-bold">
              {statistics?.roleDistribution?.provider || providerCount}
            </Badge>
          </div>

          <div className="flex items-center justify-between p-3 rounded-inner bg-info/5 transition-colors hover:bg-info/10">
            <div className="flex items-center gap-2">
              <Users className="h-4 w-4 text-info" />
              <span className="text-xs font-medium">Patients</span>
            </div>
            <Badge className="bg-info/20 text-info rounded-pill text-[10px] font-bold">
      ...
      <div className="grid grid-cols-2 gap-2">
        <Button
          ...
          className="h-12 rounded-button bg-secondary/30 dark:bg-white/5 hover:bg-secondary/40 flex items-center justify-center gap-2 group shadow-none"
          variant="ghost"
        >
            ...
            recentUsers.map((user) => (
              ...
              >
                <div className="flex items-center gap-3 min-w-0">
                  <div className="w-8 h-8 rounded-icon bg-primary/10 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform">
      ...
      {statistics && (
        <div className="space-y-2">
          ...
          <div className="p-4 bg-success/5 rounded-card flex items-center justify-around">
