    ...
    <div className="space-y-3">
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <div className="rounded-inner bg-rose-500/10 p-3 text-rose-800 shadow-[0_14px_38px_rgb(244_63_94/0.12)] dark:text-rose-200">
            <div className="flex items-center gap-2">
              <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-icon bg-background/55">
      ...
      <section className="space-y-2" aria-label="Panel actions">
        ...
        <div className="grid grid-cols-3 gap-2">
          <motion.button
            ...
            disabled={!canCreate}
            className="group flex min-h-[68px] flex-col items-center justify-center gap-2 rounded-button bg-sky-500/10 px-3 text-sky-700 shadow-[0_14px_42px_rgb(14_165_233/0.12)] transition-[background,box-shadow,transform] duration-200 hover:bg-sky-500/15 disabled:cursor-not-allowed disabled:opacity-55 dark:text-sky-200"
          ...
          <motion.button
            ...
            className="group flex min-h-[68px] flex-col items-center justify-center gap-2 rounded-button bg-muted/30 px-3 text-muted-foreground shadow-[0_14px_42px_rgb(15_23_42/0.10)] transition-[background,box-shadow,transform] duration-200 hover:bg-foreground/10 hover:text-foreground"
          >
          ...
          <motion.button
            ...
            className="group flex min-h-[68px] flex-col items-center justify-center gap-2 rounded-button bg-cyan-500/10 px-3 text-cyan-700 shadow-[0_14px_42px_rgb(6_182_212/0.12)] transition-[background,box-shadow,transform] duration-200 hover:bg-cyan-500/15 dark:text-cyan-200"
          >
