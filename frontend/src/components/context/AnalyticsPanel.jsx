  ...
  return (
    <div className="space-y-4">
      ...
      <motion.div
        ...
        className="space-y-3"
      >
        <h3 className="font-bold text-sm uppercase tracking-wider text-muted-foreground">Analytics Overview</h3>
        ...
        <Card className="bg-background/50 backdrop-blur-xs squircle-lg p-4 border-0 shadow-premium">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold tracking-tight">Avg Response</span>
            </div>
      ...
      <motion.div
        ...
        className="space-y-3"
      >
        <h3 className="font-bold text-sm uppercase tracking-wider text-muted-foreground">Performance Insights</h3>
      ...
      >
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <span className="font-bold tracking-tight text-primary">Generate Reports</span>
          </button>
          ...
          >
            ...
            <span className="font-bold tracking-tight text-success">Export Data</span>
          </button>
        </div>
      </motion.div>
    </div>
