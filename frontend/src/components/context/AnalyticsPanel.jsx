    ...
    <div className="space-y-4">
      ...
      >
        ...
        <div className="bg-muted/20 p-4 rounded-card flex items-start gap-3">
          <div className="w-10 h-10 bg-muted/40 rounded-icon flex items-center justify-center">
        ...
        {panelSignals.map(({ label, Icon }) => (
          <div key={label} className="bg-muted/15 p-4 rounded-card flex items-center justify-between group transition-all">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-muted/30 rounded-icon flex items-center justify-center group-hover:scale-105 transition-transform">
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-2">
          <button
            ...
            className="flex flex-col items-center justify-center gap-2 p-4 rounded-card bg-muted/30 hover:bg-muted/40 transition-all group"
          >
            <FileText className="h-5 w-5 text-muted-foreground group-hover:scale-110 transition-transform" />
            <span className="text-[10px] font-semibold uppercase tracking-[0.14em] text-muted-foreground">Reports</span>
          </button>
          ...
          >
            ...
            <span className="text-[10px] font-semibold uppercase tracking-[0.14em] text-muted-foreground">Export</span>
          </button>
        </div>
