...
export const COPILOT_COMMAND_REGISTRY = Object.freeze({
  [COPILOT_COMMAND_IDS.OPEN_REQUESTS]: Object.freeze({
    ...
    actionIds: Object.freeze(['review.requests', 'emergency.requests']),
  ...
  [COPILOT_COMMAND_IDS.OPEN_LIVE_MAP]: Object.freeze({
    ...
    label: 'Open live map',
    destination: '/map',
    actionIds: Object.freeze(['track.live', 'emergency.map']),
    authority: 'route-navigation',
    idempotent: true,
  }),
  [COPILOT_COMMAND_IDS.OPEN_APPROVALS]: Object.freeze({
    ...
    actionIds: Object.freeze(['review.approvals', 'organization.approvals']),
    authority: 'route-navigation',
    idempotent: true,
  }),
  [COPILOT_COMMAND_IDS.OPEN_ORGANIZATIONS]: Object.freeze({
    ...
    actionIds: Object.freeze(['manage.organizations']),
    authority: 'route-navigation',
    idempotent: true,
  }),
  [COPILOT_COMMAND_IDS.OPEN_FACILITIES]: Object.freeze({
    ...
    actionIds: Object.freeze(['manage.facilities', 'organization.facilities']),
    authority: 'route-navigation',
    idempotent: true,
  }),
  [COPILOT_COMMAND_IDS.OPEN_PROVIDERS]: Object.freeze({
    ...
    actionIds: Object.freeze(['manage.providers', 'organization.providers']),
    authority: 'route-navigation',
    idempotent: true,
  }),
  ...
  [COPILOT_COMMAND_IDS.OPEN_SCHEDULES]: Object.freeze({
    ...
    actionIds: Object.freeze(['prepare.schedules', 'organization.schedules']),
    authority: 'route-navigation',
    idempotent: true,
  }),
  [COPILOT_COMMAND_IDS.OPEN_FINANCE]: Object.freeze({
    ...
    label: 'Open Finance',
    destination: '/wallet',
    actionIds: Object.freeze(['emergency.finance']),
    authority: 'route-navigation',
    idempotent: true,
  }),
});
